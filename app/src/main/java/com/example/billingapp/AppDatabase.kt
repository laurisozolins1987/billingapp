...
@Database(entities = [Transaction::class, Category::class, Folder::class, Bill::class], version = 7, exportSchema = false)
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_6_7 = object : Migration(6, 7) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE bills ADD COLUMN invoiceNumber TEXT NOT NULL DEFAULT ''")
                database.execSQL("ALTER TABLE bills ADD COLUMN receivedDate INTEGER NOT NULL DEFAULT 0")
            }
        }
